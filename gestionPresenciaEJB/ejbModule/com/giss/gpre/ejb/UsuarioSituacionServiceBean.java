...
/**
 * Implementación del servicio para consultas de situación de usuarios
 * Ejecuta queries nativas para obtener información detallada combinando
 * múltiples tablas de la base de datos
 * 
 * @author GISS
 */
@Stateless
public class UsuarioSituacionServiceBean implements UsuarioSituacionService {

    @PersistenceContext(unitName = "gestionPresencia")
    private EntityManager em;

    @Override
    public List<DatosUsuarioSituacion> obtenerSituacionUsuarios(String cdUsuario) {
        ...
        try {
            ...
            System.err.println("Error al obtener situación de usuarios: " + e.getMessage());
            e.printStackTrace();
        }
