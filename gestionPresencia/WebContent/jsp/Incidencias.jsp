...
<%
	...
	// URL del pdf
    String pdfUrl = (String) LimpiarParametro.getAttributeObject(ESAPI.currentRequest(), ESAPI.encoder().encodeForHTMLAttribute("pdf"));
%>

<!-- Elemento oculto para almacenar la URL del PDF -->
<input type="hidden" id="pdfUrl" value="<%= pdfUrl != null ? pdfUrl : "" %>">
<div class="page">
			...
			<div id="elementCountDisplay" class="controls-page-title"
				...
				<div class="controls-header">
					<div class="controls-title">
						<span id="elementCount">0</span> Incidencias
					</div>
				</div>
			</div>
			<table id="dataTable">
				<caption class="invisible">Datos de incidencias</caption>
				<thead>
					<tr id="theadRow">
					</tr>
				</thead>
				<tbody id="tbody" data-json='${listaIncidencias}'>
				</tbody>
			</table>
